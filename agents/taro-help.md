...
6. For Recorder-first generation, use `$@taro-test/rtl-generate`. For forced interactive auth recovery, use `$@taro-test/rtl-generate-i`. For explicit component targeting, use `$@taro-test/rtl-target`.
