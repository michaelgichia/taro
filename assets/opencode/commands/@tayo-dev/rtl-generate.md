...
Generate a React Testing Library test from a Testing Library Recorder JS export or Chrome Recorder JSON export.

## Process

1. Confirm the recording file path. Prefer `.js` exports; `.json` is also supported.
...
5. Re-score — `tayo generate --dry-run --force <file>` to verify improvement.
