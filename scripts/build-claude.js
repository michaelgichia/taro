...
const globalClaudePackageDir = join(
  homedir(),
  ".claude",
  "commands",
  "@taro-dev",
...
const legacyGlobalClaudePackageDir = join(
  homedir(),
  ".claude",
  "commands",
  "@tayo-dev",
...
console.log(
  `[taro] Removing existing global Claude commands at ${globalClaudePackageDir}...`
);
await rm(globalClaudePackageDir, { recursive: true, force: true });
console.log(
  `[taro] Removing legacy global Claude commands at ${legacyGlobalClaudePackageDir}...`
);
