...
argument-instructions: |
  ...
  Example: /@tr/rtl:gen path/to/recording.js
...
10. Inspect the machine-readable findings block. If it includes `mock-boundary`, `mock-instability`, `mock-lifecycle`, or `mock-support`, run one bounded mock-review repair pass using the `/@tr/rtl:mocks` contract against the generated file.
