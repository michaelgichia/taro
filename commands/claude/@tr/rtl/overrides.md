...
5. After scaffold succeeds, direct them to `/@tr/rtl:refresh` if they want Taro to reload the new policy, or to `/@tr/rtl:gen` or `/@tr/rtl:target` if they want generation help next.
</process>
