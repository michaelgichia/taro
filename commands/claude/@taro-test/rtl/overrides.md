...
5. After scaffold succeeds, direct them to `/@taro-test/rtl:refresh` if they want Taro to reload the new policy, or to `/@taro-test/rtl:generate` or `/@taro-test/rtl:target` if they want generation help next.
</process>
