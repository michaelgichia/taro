...
Taro v1.0 shipped the end-to-end recorder-to-RTL pipeline, added query/test-design intelligence, layered in scoring and convention learning, recovered the missing recording/visual/mock intelligence scope, and closed the milestone with a full traceability reconciliation.
