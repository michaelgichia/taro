...
**Phase Goal:** Make the new batch regrade behavior discoverable and keep the runtime surfaces in sync. **Verified:** 2026-03-31T08:03:00Z **Status:** passed
...
**Verification approach:** Goal-backward from Phase 4 docs/runtime must-haves plus shipped-asset regression coverage **Automated checks:** Existing install/runtime, package smoke, and CLI smoke suites **Human checks required:** 0 **Total verification time:** 6 min

---

_Verified: 2026-03-31T08:03:00Z_ _Verifier: the agent_
