...
- [ ] Interactive review and refinement before Tayo writes a generated test file
...
- [Broad `Tayo` / `tayo` brand rename] — keep the milestone focused on JS baseline quality, not product identity work
