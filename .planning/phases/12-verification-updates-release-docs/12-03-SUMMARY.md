...
- Kept the `taro generate` documentation, but moved it after onboarding so the README matches the real entrypoint of the package.

## Verification

- `rg -n "Getting Started|Staying Updated|Non-interactive Install|Development Installation|@tayo-dev/rtl@latest" README.md`
- `env NPM_CONFIG_CACHE=/tmp/taro-npm-cache npm pack --dry-run`
