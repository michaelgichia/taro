...
| Dropping or regressing Chrome Recorder JSON support | v1.3 raises JS fidelity but must preserve the existing JSON path |
...
| Installer/distribution work unrelated to JS baseline quality | The active milestone is generation fidelity, not runtime packaging changes |
