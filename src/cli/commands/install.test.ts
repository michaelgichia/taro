...
describe("runInstallCommand", () => {
  it("installs all runtimes and reports verification commands", async () => {
    ...
    await runInstallCommand(
      ...
      { cwd: sandbox.cwd, home: sandbox.home, logger }
    );
  ...
  it("reports update results on rerun in non-interactive mode", async () => {
    ...
    await runInstallCommand(
      ...
      { cwd: sandbox.cwd, home: sandbox.home, logger: firstRun.logger }
    );
    ...
    await runInstallCommand(
      { claude: true, global: true },
      { cwd: sandbox.cwd, home: sandbox.home, logger: secondRun.logger }
    );
