...
const PROMPT_RUNTIME_ASSETS: Record<PromptRuntimeTarget, RuntimeAssetDefinition[]> = {
  claude: [
    ...
    },
    {
      id: 'generate',
      kind: 'command',
      sourceSegments: ['commands', 'claude', '@taro-test', 'rtl', 'generate.md'],
    ...
    },
    {
      id: 'generate-i',
      kind: 'command',
      sourceSegments: ['commands', 'claude', '@taro-test', 'rtl', 'generate-i.md'],
    ...
    ...TARO_REFERENCE_FILES.map((fileName) => ({
      ...
      destinationSegments: ['commands', '@taro-test', 'rtl', 'references', fileName],
    })),
  ],
  gemini: [
    {
    ...
    },
    {
      id: 'generate',
      kind: 'command',
      sourceSegments: ['commands', 'gemini', '@taro-test', 'rtl', 'generate.toml'],
    ...
    },
    {
      id: 'generate-i',
      kind: 'command',
      sourceSegments: ['commands', 'gemini', '@taro-test', 'rtl', 'generate-i.toml'],
  ...
  opencode: [
    ...
    },
    {
      id: 'generate-i',
      kind: 'command',
      sourceSegments: ['commands', 'opencode', '@taro-test', 'rtl-generate-i.md'],
      destinationSegments: ['commands', '@taro-test', 'rtl-generate-i.md'],
      entrypoint: '/@taro-test/rtl-generate-i',
    },
    {
