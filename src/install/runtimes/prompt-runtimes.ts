...
> = {
  claude: [
    ...
    },
    {
      id: "generate",
      kind: "command",
      sourceSegments: ["commands", "claude", "@tr-rtl", "cli", "gen.md"],
    ...
    },
    {
      id: "generate-i",
      kind: "command",
      sourceSegments: ["commands", "claude", "@tr-rtl", "cli", "geni.md"],
    ...
    },
    {
      id: "overrides",
      kind: "command",
      sourceSegments: ["commands", "claude", "@tr-rtl", "cli", "overrides.md"],
  ...
  gemini: [
    ...
    },
    {
      id: "generate",
      kind: "command",
      sourceSegments: ["commands", "gemini", "@tr-rtl", "cli", "gen.toml"],
    ...
    },
    {
      id: "generate-i",
      kind: "command",
      sourceSegments: ["commands", "gemini", "@tr-rtl", "cli", "geni.toml"],
    ...
    },
    {
      id: "regrade",
      kind: "command",
      sourceSegments: ["commands", "gemini", "@tr-rtl", "cli", "regrade.toml"],
    ...
    },
    {
      id: "target",
      kind: "command",
      sourceSegments: ["commands", "gemini", "@tr-rtl", "cli", "target.toml"],
    ...
    },
    {
      id: "refresh",
      kind: "command",
      sourceSegments: ["commands", "gemini", "@tr-rtl", "cli", "refresh.toml"],
  ...
  opencode: [
    ...
    },
    {
      id: "generate-i",
      kind: "command",
      sourceSegments: ["commands", "opencode", "@tr-rtl", "cli-geni.md"],
      destinationSegments: ["commands", "@tr-rtl", "cli-geni.md"],
      entrypoint: "/@tr-rtl/cli-geni",
    },
    {
    ...
    },
    {
      id: "overrides",
      kind: "command",
      sourceSegments: ["commands", "opencode", "@tr-rtl", "cli-overrides.md"],
      destinationSegments: ["commands", "@tr-rtl", "cli-overrides.md"],
      entrypoint: "/@tr-rtl/cli-overrides",
    },
  ],
